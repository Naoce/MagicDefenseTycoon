...
public class MapManager : MonoBehaviour
{
    ...
    public void WinGame()
    {
        ...
        if (gm.GetComponent<GameManager>().currSave == 1)
        {
            ...
            PlayerPrefs.SetInt("Load1PlayerStockHealthPotion", player.GetComponent<StatsPlayer>().stockHealthPotion);
            PlayerPrefs.SetInt("Load1PlayerStockManaPotion", player.GetComponent<StatsPlayer>().stockManaPotion);
        ...
        else if (gm.GetComponent<GameManager>().currSave == 2)
        {
            ...
            PlayerPrefs.SetInt("Load2PlayerStockHealthPotion", player.GetComponent<StatsPlayer>().stockHealthPotion);
            PlayerPrefs.SetInt("Load2PlayerStockManaPotion", player.GetComponent<StatsPlayer>().stockManaPotion);
        ...
        else if (gm.GetComponent<GameManager>().currSave == 3)
        {
            ...
            PlayerPrefs.SetInt("Load3PlayerStockHealthPotion", player.GetComponent<StatsPlayer>().stockHealthPotion);
            PlayerPrefs.SetInt("Load3PlayerStockManaPotion", player.GetComponent<StatsPlayer>().stockManaPotion);
    ...
    void InstantiateGuerrierNormal(Vector2 pos, Vector2 targetPos)
    {
        GameObject obj = null;
