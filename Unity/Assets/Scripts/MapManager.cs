...
public class MapManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (gm.GetComponent<GameManager>().gamePaused == false)
        {
            if (mapID == 0)
                ...
                UpdateMap3();
            else if (mapID == 4 || mapID == 8)
                UpdateMap4();
            else if (mapID == 5 || mapID == 6 || mapID == 7)
                UpdateMap5();
            else if (mapID == 9 || mapID == 10)
                UpdateMap9();
        }
    }
    ...
    void UpdateMap0()
    {
        ...
        if (idGen == maxIdGen && canSpawn == true)
        {
            ...
            obj = (GameObject)Instantiate(EnemyCharacters[2], posBoss, transform.rotation);
    ...
    void UpdateMap3() // capture
    {
        if (canSpawn == true)
        {
            ...
            {
                timerSpawn = 0f;
                StartCoroutine(InstantiateCharacter(posEnemies[0], new Vector2(posEnemies[0].x, posEnemies[0].y - 0.5f), 0f, EnemyCharacters[0]));
                StartCoroutine(InstantiateCharacter(posEnemies[0], new Vector2(posEnemies[0].x, posEnemies[0].y - 0.5f), 0.5f, EnemyCharacters[1]));
                StartCoroutine(InstantiateCharacter(posEnemies[0], new Vector2(posEnemies[0].x, posEnemies[0].y - 0.5f), 1f, EnemyCharacters[2]));
                StartCoroutine(InstantiateCharacter(posEnemies[1], new Vector2(posEnemies[1].x, posEnemies[1].y - 0.5f), 0, EnemyCharacters[0]));
                StartCoroutine(InstantiateCharacter(posEnemies[1], new Vector2(posEnemies[1].x, posEnemies[1].y - 0.5f), 0.5f, EnemyCharacters[1]));
                StartCoroutine(InstantiateCharacter(posEnemies[1], new Vector2(posEnemies[1].x, posEnemies[1].y - 0.5f), 1f, EnemyCharacters[2]));
            }
    ...
    void UpdateMap4() // defense
    {
        if (canSpawn == true)
        {
            ...
            {
                timerSpawn = 0f;
                StartCoroutine(InstantiateCharacter(posEnemies[0], new Vector2(posEnemies[0].x, posEnemies[0].y - 0.5f), 0, EnemyCharacters[0]));
                StartCoroutine(InstantiateCharacter(posEnemies[1], new Vector2(posEnemies[1].x, posEnemies[1].y - 0.5f), 0f, EnemyCharacters[0]));
                StartCoroutine(InstantiateCharacter(posEnemies[0], new Vector2(posEnemies[0].x, posEnemies[0].y - 0.5f), 0.5f, EnemyCharacters[1]));
                StartCoroutine(InstantiateCharacter(posEnemies[1], new Vector2(posEnemies[1].x, posEnemies[1].y - 0.5f), 0.5f, EnemyCharacters[1]));
            }
        }
    ...
    void UpdateMap9() // map pont defense
    {
        if (canSpawn == true)
        {
            timerSpawn += Time.deltaTime;
            if (timerSpawn > timerMax)
            {
                ...
                StartCoroutine(InstantiateCharacter(posEnemies[0], new Vector2(posEnemies[0].x, posEnemies[0].y - 0.5f), 0, EnemyCharacters[0]));
                StartCoroutine(InstantiateCharacter(posEnemies[1], new Vector2(posEnemies[1].x, posEnemies[1].y - 0.5f), 0f, EnemyCharacters[0]));
                StartCoroutine(InstantiateCharacter(posEnemies[0], new Vector2(posEnemies[0].x, posEnemies[0].y - 0.5f), 1f, EnemyCharacters[1]));
                StartCoroutine(InstantiateCharacter(posEnemies[1], new Vector2(posEnemies[1].x, posEnemies[1].y - 0.5f), 1f, EnemyCharacters[1]));
            }
        }
        else if (canSpawn == false &&
                enemiesList.Count == 0 &&
    ...
    IEnumerator InstantiateCharacter(Vector2 pos, Vector2 targetPos, float durationCast, GameObject objToSpawn)
    {
        yield return new WaitForSeconds(durationCast);

        GameObject obj = null;

        obj = (GameObject)Instantiate(objToSpawn, pos, transform.rotation);
        obj.GetComponent<Enemy>().id = idGen++;
        obj.GetComponent<IAGuerrier>().player = player;
    ...
    IEnumerator Map1()
    {
        ...
        GameObject obj1;
        obj1 = (GameObject)Instantiate(EnemyCharacters[0], vec1, transform.rotation);
        ...
        GameObject obj2;
        obj2 = (GameObject)Instantiate(EnemyCharacters[1], vec2, transform.rotation);
    ...
    private void FillTabNodes()
    {
        ...
        if (mapID == 9 || mapID == 10)
        {
            tabNodes = new GameObject[11][];
            tabNodes[0] = new GameObject[19];
            tabNodes[1] = new GameObject[19];
            tabNodes[2] = new GameObject[19];
            tabNodes[3] = new GameObject[19];
            tabNodes[4] = new GameObject[19];
            tabNodes[5] = new GameObject[19];
            tabNodes[6] = new GameObject[19];
            tabNodes[7] = new GameObject[19];
            tabNodes[8] = new GameObject[19];
            tabNodes[9] = new GameObject[19];
            tabNodes[10] = new GameObject[19];
           /* tabNodes[11] = new GameObject[37];
            tabNodes[12] = new GameObject[37];
            tabNodes[13] = new GameObject[37];
            tabNodes[14] = new GameObject[37];
            tabNodes[15] = new GameObject[37];
            tabNodes[16] = new GameObject[37];
            tabNodes[17] = new GameObject[37];
            tabNodes[18] = new GameObject[37];
            tabNodes[19] = new GameObject[37];
            tabNodes[20] = new GameObject[37];*/
           ...
           /* tabNodes[0][19] = GameObject.Find("Nodes/Node 19 (0)");
            ...
            tabNodes[0][33] = GameObject.Find("Nodes/Node 33 (0)");
            tabNodes[0][34] = GameObject.Find("Nodes/Node 34 (0)");
            tabNodes[0][35] = GameObject.Find("Nodes/Node 35 (0)");
            tabNodes[0][36] = GameObject.Find("Nodes/Node 36 (0)");*/
           ...
           /* tabNodes[1][19] = GameObject.Find("Nodes/Node 19 (1)");
            ...
            tabNodes[1][33] = GameObject.Find("Nodes/Node 33 (1)");
            tabNodes[1][34] = GameObject.Find("Nodes/Node 34 (1)");
            tabNodes[1][35] = GameObject.Find("Nodes/Node 35 (1)");
            tabNodes[1][36] = GameObject.Find("Nodes/Node 36 (1)");*/
          ...
          /*  tabNodes[2][19] = GameObject.Find("Nodes/Node 19 (2)");
            ...
            tabNodes[2][33] = GameObject.Find("Nodes/Node 33 (2)");
            tabNodes[2][34] = GameObject.Find("Nodes/Node 34 (2)");
            tabNodes[2][35] = GameObject.Find("Nodes/Node 35 (2)");
            tabNodes[2][36] = GameObject.Find("Nodes/Node 36 (2)");*/
         ...
         /*   tabNodes[3][19] = GameObject.Find("Nodes/Node 19 (3)");
            ...
            tabNodes[3][33] = GameObject.Find("Nodes/Node 33 (3)");
            tabNodes[3][34] = GameObject.Find("Nodes/Node 34 (3)");
            tabNodes[3][35] = GameObject.Find("Nodes/Node 35 (3)");
            tabNodes[3][36] = GameObject.Find("Nodes/Node 36 (3)");*/
          ...
          /*  tabNodes[4][19] = GameObject.Find("Nodes/Node 19 (4)");
            ...
            tabNodes[4][33] = GameObject.Find("Nodes/Node 33 (4)");
            tabNodes[4][34] = GameObject.Find("Nodes/Node 34 (4)");
            tabNodes[4][35] = GameObject.Find("Nodes/Node 35 (4)");
            tabNodes[4][36] = GameObject.Find("Nodes/Node 36 (4)");*/
         ...
         /*   tabNodes[5][19] = GameObject.Find("Nodes/Node 19 (5)");
            ...
            tabNodes[5][33] = GameObject.Find("Nodes/Node 33 (5)");
            tabNodes[5][34] = GameObject.Find("Nodes/Node 34 (5)");
            tabNodes[5][35] = GameObject.Find("Nodes/Node 35 (5)");
            tabNodes[5][36] = GameObject.Find("Nodes/Node 36 (5)");*/
         ...
         /*   tabNodes[6][19] = GameObject.Find("Nodes/Node 19 (6)");
            ...
            tabNodes[6][33] = GameObject.Find("Nodes/Node 33 (6)");
            tabNodes[6][34] = GameObject.Find("Nodes/Node 34 (6)");
            tabNodes[6][35] = GameObject.Find("Nodes/Node 35 (6)");
            tabNodes[6][36] = GameObject.Find("Nodes/Node 36 (6)");*/
         ...
         /*   tabNodes[7][19] = GameObject.Find("Nodes/Node 19 (7)");
            ...
            tabNodes[7][33] = GameObject.Find("Nodes/Node 33 (7)");
            tabNodes[7][34] = GameObject.Find("Nodes/Node 34 (7)");
            tabNodes[7][35] = GameObject.Find("Nodes/Node 35 (7)");
            tabNodes[7][36] = GameObject.Find("Nodes/Node 36 (7)");*/
           ...
           /* tabNodes[8][19] = GameObject.Find("Nodes/Node 19 (8)");
            ...
            tabNodes[8][33] = GameObject.Find("Nodes/Node 33 (8)");
            tabNodes[8][34] = GameObject.Find("Nodes/Node 34 (8)");
            tabNodes[8][35] = GameObject.Find("Nodes/Node 35 (8)");
            tabNodes[8][36] = GameObject.Find("Nodes/Node 36 (8)");*/
          ...
          /*  tabNodes[9][19] = GameObject.Find("Nodes/Node 19 (9)");
            ...
            tabNodes[9][33] = GameObject.Find("Nodes/Node 33 (9)");
            tabNodes[9][34] = GameObject.Find("Nodes/Node 34 (9)");
            tabNodes[9][35] = GameObject.Find("Nodes/Node 35 (9)");
            tabNodes[9][36] = GameObject.Find("Nodes/Node 36 (9)");*/
         ...
         /*   tabNodes[10][19] = GameObject.Find("Nodes/Node 19 (10)");
            ...
            tabNodes[10][33] = GameObject.Find("Nodes/Node 33 (10)");
            tabNodes[10][34] = GameObject.Find("Nodes/Node 34 (10)");
            tabNodes[10][35] = GameObject.Find("Nodes/Node 35 (10)");
            tabNodes[10][36] = GameObject.Find("Nodes/Node 36 (10)");*/
...
/*   tabNodes[11][0] = GameObject.Find("Nodes/Node 0 (11)");
   ...
   tabNodes[11][33] = GameObject.Find("Nodes/Node 33 (11)");
   tabNodes[11][34] = GameObject.Find("Nodes/Node 34 (11)");
   tabNodes[11][35] = GameObject.Find("Nodes/Node 35 (11)");
   tabNodes[11][36] = GameObject.Find("Nodes/Node 36 (11)");
   ...
   tabNodes[12][33] = GameObject.Find("Nodes/Node 33 (12)");
   tabNodes[12][34] = GameObject.Find("Nodes/Node 34 (12)");
   tabNodes[12][35] = GameObject.Find("Nodes/Node 35 (12)");
   tabNodes[12][36] = GameObject.Find("Nodes/Node 36 (12)");
   ...
   tabNodes[13][33] = GameObject.Find("Nodes/Node 33 (13)");
   tabNodes[13][34] = GameObject.Find("Nodes/Node 34 (13)");
   tabNodes[13][35] = GameObject.Find("Nodes/Node 35 (13)");
   tabNodes[13][36] = GameObject.Find("Nodes/Node 36 (13)");
   ...
   tabNodes[14][33] = GameObject.Find("Nodes/Node 33 (14)");
   tabNodes[14][34] = GameObject.Find("Nodes/Node 34 (14)");
   tabNodes[14][35] = GameObject.Find("Nodes/Node 35 (14)");
   tabNodes[14][36] = GameObject.Find("Nodes/Node 36 (14)");
   ...
   tabNodes[15][33] = GameObject.Find("Nodes/Node 33 (15)");
   tabNodes[15][34] = GameObject.Find("Nodes/Node 34 (15)");
   tabNodes[15][35] = GameObject.Find("Nodes/Node 35 (15)");
   tabNodes[15][36] = GameObject.Find("Nodes/Node 36 (15)");
   ...
   tabNodes[16][33] = GameObject.Find("Nodes/Node 33 (16)");
   tabNodes[16][34] = GameObject.Find("Nodes/Node 34 (16)");
   tabNodes[16][35] = GameObject.Find("Nodes/Node 35 (16)");
   tabNodes[16][36] = GameObject.Find("Nodes/Node 36 (16)");
   ...
   tabNodes[17][33] = GameObject.Find("Nodes/Node 33 (17)");
   tabNodes[17][34] = GameObject.Find("Nodes/Node 34 (17)");
   tabNodes[17][35] = GameObject.Find("Nodes/Node 35 (17)");
   tabNodes[17][36] = GameObject.Find("Nodes/Node 36 (17)");
   ...
   tabNodes[18][33] = GameObject.Find("Nodes/Node 33 (18)");
   tabNodes[18][34] = GameObject.Find("Nodes/Node 34 (18)");
   tabNodes[18][35] = GameObject.Find("Nodes/Node 35 (18)");
   tabNodes[18][36] = GameObject.Find("Nodes/Node 36 (18)");
   ...
   tabNodes[19][20] = GameObject.Find("Nodes/Node 20 (19)");
   tabNodes[19][21] = GameObject.Find("Nodes/Node 21 (19)");
   tabNodes[19][22] = GameObject.Find("Nodes/Node 22 (19)");
   tabNodes[19][23] = GameObject.Find("Nodes/Node 23 (19)");
   tabNodes[19][24] = GameObject.Find("Nodes/Node 24 (19)");
   tabNodes[19][25] = GameObject.Find("Nodes/Node 25 (19)");
   tabNodes[19][26] = GameObject.Find("Nodes/Node 26 (19)");
   tabNodes[19][27] = GameObject.Find("Nodes/Node 27 (19)");
   tabNodes[19][28] = GameObject.Find("Nodes/Node 28 (19)");
   tabNodes[19][29] = GameObject.Find("Nodes/Node 29 (19)");
   tabNodes[19][30] = GameObject.Find("Nodes/Node 30 (19)");
   tabNodes[19][31] = GameObject.Find("Nodes/Node 31 (19)");
   tabNodes[19][32] = GameObject.Find("Nodes/Node 32 (19)");
   tabNodes[19][33] = GameObject.Find("Nodes/Node 33 (19)");
   tabNodes[19][34] = GameObject.Find("Nodes/Node 34 (19)");
   tabNodes[19][35] = GameObject.Find("Nodes/Node 35 (19)");
   tabNodes[19][36] = GameObject.Find("Nodes/Node 36 (19)");
   ...
   tabNodes[20][20] = GameObject.Find("Nodes/Node 20 (20)");
   tabNodes[20][21] = GameObject.Find("Nodes/Node 21 (20)");
   tabNodes[20][22] = GameObject.Find("Nodes/Node 22 (20)");
   tabNodes[20][23] = GameObject.Find("Nodes/Node 23 (20)");
   tabNodes[20][24] = GameObject.Find("Nodes/Node 24 (20)");
   tabNodes[20][25] = GameObject.Find("Nodes/Node 25 (20)");
   tabNodes[20][26] = GameObject.Find("Nodes/Node 26 (20)");
   tabNodes[20][27] = GameObject.Find("Nodes/Node 27 (20)");
   tabNodes[20][28] = GameObject.Find("Nodes/Node 28 (20)");
   tabNodes[20][29] = GameObject.Find("Nodes/Node 29 (20)");
   tabNodes[20][30] = GameObject.Find("Nodes/Node 30 (20)");
   tabNodes[20][31] = GameObject.Find("Nodes/Node 31 (20)");
   tabNodes[20][32] = GameObject.Find("Nodes/Node 32 (20)");
   tabNodes[20][33] = GameObject.Find("Nodes/Node 33 (20)");
   tabNodes[20][34] = GameObject.Find("Nodes/Node 34 (20)");
   tabNodes[20][35] = GameObject.Find("Nodes/Node 35 (20)");
   tabNodes[20][36] = GameObject.Find("Nodes/Node 36 (20)");*/
}
}
}
